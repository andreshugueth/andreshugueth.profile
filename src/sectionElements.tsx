...
export const sectionElements = [
  {
    ...
    content: [
      <p className="mx-auto w-1/2">
        Software and Mechanical Engineer passionate about technology and
        innovation. I have experience in software development, data analysis,
        and project management. I am a quick learner and a team player
      </p>,
    ],
  },
  {
